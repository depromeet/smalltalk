          ...
          <div className={cx("navi_box")} style={ this.toggleMenu(this.state.isToggleOn) }>
            ...
            <div className={cx("menu_box")}>
              ...
              <div className={cx("menu")}>
                <Link to="/mypage" className={cx("menu-list")} 
                onMouseOver={ this.handleMouseOver1 } onMouseOut={ this.handleMouseOut1 }>
                  MYPAGE
                  <div className={cx("menu-box")} 
                  style={{ left: this.state.left1, opacity: this.state.opacitiy1 }}></div>
                </Link>
                <Link to="/schedule" className={cx("menu-list")} 
                onMouseOver={ this.handleMouseOver2 } onMouseOut={ this.handleMouseOut2 }>
                  SCHEDULE
                  <div className={cx("menu-box")} 
                  style={{ left: this.state.left2, opacity: this.state.opacitiy2 }}></div>
                </Link>
                <Link to="/mate" className={cx("menu-list")} 
                onMouseOver={ this.handleMouseOver3 } onMouseOut={ this.handleMouseOut3 }>
                  MATE
                  <div className={cx("menu-box")} 
                  style={{ left: this.state.left3, opacity: this.state.opacitiy3 }}></div>
                </Link>
                <Link to="/bigdata" className={cx("menu-list")} 
                onMouseOver={ this.handleMouseOver4 } onMouseOut={ this.handleMouseOut4 }>
                  BIGDATA
                  <div className={cx("menu-box")} 
                  style={{ left: this.state.left4, opacity: this.state.opacitiy4 }}></div>
                </Link>
